import{S as he,i as de,s as fe,e as s,t as c,a as w,c as n,b as i,d as h,f as r,g as b,h as t,j as ue,k as e,n as V}from"../chunks/index.22613a01.js";function me(H){let a,p,_,k,y,L,d,j,O,R,E,W,q,M,B,C,A,U,F,l,D,f,T,X,I,u,z,G,P,m,J,K,x,v,Q;return{c(){a=s("main"),p=s("p"),_=c("WIP: barebones homepage for this work"),k=w(),y=s("p"),L=c(`Check this out in person! If you will be at NeurIPS'23, let's connect at the
    ...
    research directions revealed by the extent of their similarities.`),C=w(),A=s("h2"),U=c("Links"),F=w(),l=s("ul"),D=s("li"),f=s("a"),T=c("OpenReview (short version)"),X=w(),I=s("li"),u=s("a"),z=c("Initial Twitter Announcement"),G=w(),P=s("li"),m=s("a"),J=c("Paper on ArXiv (long version)"),K=w(),x=s("li"),v=s("a"),Q=c("NeurIPS 2023 virtual page"),this.h()},l(S){a=n(S,"MAIN",{});var o=i(a);p=n(o,"P",{class:!0});var Y=i(p);_=h(Y,"WIP: barebones homepage for this work"),Y.forEach(r),k=b(o),y=n(o,"P",{class:!0});var N=i(y);L=h(N,`Check this out in person! If you will be at NeurIPS'23, let's connect at the
    AMHN (Associative Memory & Hopfield Network) Workshop! Fri Dec 15 Room 223.
